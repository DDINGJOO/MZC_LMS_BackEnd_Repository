...
/**
 * 교수 강의 관리 UseCase 구현체
 */
@Slf4j
@Service
@RequiredArgsConstructor
@Transactional
public class ProfessorCourseService implements ProfessorCourseUseCase {
    ...
    // External Ports
    private final AcademicTermPort academicTermPort;
    ...
    private EnrollmentPeriod findEnrollmentPeriod(Long enrollmentPeriodId) {
        ...
        return enrollmentPeriodPort.findById(enrollmentPeriodId)
    ...
    private Professor findProfessor(Long professorId) {
        ...
        return professorPort.findById(professorId)
    ...
    private Department findProfessorPrimaryDepartment(Long professorId) {
        return professorPort.findPrimaryDepartmentByProfessorId(professorId)
    ...
    private Subject createNewSubject(CreateCourseRequestDto.SubjectRequestDto subjectReq, Long professorId,
        ...
        // 과목 코드 중복 체크
            ...
            Department subjectDept = subjectReq.getDepartmentId() != null ?
                    professorPort.findPrimaryDepartmentByProfessorId(professorId)
    ...
    private void validateNoEnrollments(Long courseId) {
        long enrollmentCount = enrollmentPort.countByCourseId(courseId);
    ...
    public MyCoursesResponseDto getMyCourses(Long professorId, Long academicTermId) {
        ...
        if (academicTermId != null) {
            academicTerm = academicTermPort.findById(academicTermId)
    ...
    private boolean isCourseRegistrationPeriodActive() {
        ...
        return enrollmentPeriodPort.existsActiveCourseRegistrationPeriod(now);
    }
