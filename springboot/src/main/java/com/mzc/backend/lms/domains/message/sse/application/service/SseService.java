package com.mzc.backend.lms.domains.message.sse.application.service;

import com.mzc.backend.lms.domains.message.sse.adapter.in.web.dto.MessageNotificationDto;
import com.mzc.backend.lms.domains.message.sse.adapter.out.persistence.repository.SseEmitterRepositoryJpa;
...
public class SseService {
    ...
    private final SseEmitterRepositoryJpa sseEmitterRepository;
