package com.mzc.backend.lms.domains.course.grade.adapter.out.persistence.repository;
...
public interface GradeRepository extends JpaRepository<Grade, Long> {
    ...
    @Query("""
            ...
            WHERE g.studentId = :studentId
              ...
              AND g.status = com.mzc.backend.lms.domains.course.grade.domain.enums.GradeStatus.PUBLISHED
