package com.mzc.backend.lms.domains.board.assignment.adapter.out.persistence.repository;
 ...
 */
@Repository
public interface AssignmentSubmissionRepositoryJpa extends JpaRepository<AssignmentSubmission, Long> {
