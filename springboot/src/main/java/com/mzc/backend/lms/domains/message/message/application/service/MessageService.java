package com.mzc.backend.lms.domains.message.message.application.service;

import com.mzc.backend.lms.domains.message.conversation.adapter.out.persistence.entity.Conversation;
import com.mzc.backend.lms.domains.message.conversation.adapter.out.persistence.repository.ConversationJpaRepository;
import com.mzc.backend.lms.domains.message.exception.MessageException;
import com.mzc.backend.lms.domains.message.message.adapter.in.web.dto.MessageBulkSendRequestDto;
import com.mzc.backend.lms.domains.message.message.adapter.in.web.dto.MessageCursorResponseDto;
import com.mzc.backend.lms.domains.message.message.adapter.in.web.dto.MessageResponseDto;
import com.mzc.backend.lms.domains.message.message.adapter.in.web.dto.MessageSendRequestDto;
import com.mzc.backend.lms.domains.message.message.adapter.out.persistence.entity.Message;
import com.mzc.backend.lms.domains.message.message.adapter.out.persistence.repository.MessageJpaRepository;
import com.mzc.backend.lms.domains.message.sse.adapter.in.web.dto.MessageNotificationDto;
import com.mzc.backend.lms.domains.message.sse.application.service.SseService;
