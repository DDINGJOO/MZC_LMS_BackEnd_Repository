 ...
 * User 도메인과의 결합도를 낮추기 위해 필요한 쿼리만 제공
 */
@Repository
public class UserTypeQueryRepositoryJpa extends BaseCustomRepository<Void> {

    public UserTypeQueryRepositoryJpa() {
        super();
    }
    ...
    public Optional<String> findUserTypeCodeByUserId(Long userId) {
        ...
        try {
            String typeCode = createQuery(jpql, String.class)
