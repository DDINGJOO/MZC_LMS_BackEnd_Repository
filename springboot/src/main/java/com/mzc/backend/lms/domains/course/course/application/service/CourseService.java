...
public class CourseService implements CourseQueryUseCase {

    // Persistence Ports
    private final CourseRepositoryPort courseRepository;
    private final CourseWeekRepositoryPort courseWeekRepository;
    private final SubjectPrerequisitesPort subjectPrerequisitesPort;
    ...
    private List<Course> filterCourses(CourseSearchRequestDto request) {
        ...
        // EnrollmentPeriod 조회
        EnrollmentPeriod enrollmentPeriod = enrollmentPeriodPort.findById(request.getEnrollmentPeriodId())
        ...
        if (request.getKeyword() != null && !request.getKeyword().trim().isEmpty()) {
            ...
            courses = courses.stream()
                    .filter(c -> {
                        ...
                        String professorName = userViewPort.getUserName(
    ...
    public CourseDetailDto getCourseDetail(Long courseId) {
        ...
        // 선수과목 정보 조회
        List<SubjectPrerequisites> prerequisites = subjectPrerequisitesPort.findBySubjectId(subject.getId());
