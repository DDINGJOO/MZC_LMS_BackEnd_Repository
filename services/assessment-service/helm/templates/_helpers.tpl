...
*/}}
{{- define "assessment-service.chart" -}}
...
helm.sh/chart: {{ include "assessment-service.chart" . }}
{{ include "assessment-service.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
{{- default (include "assessment-service.fullname" .) .Values.serviceAccount.name }}
{{- else }}
